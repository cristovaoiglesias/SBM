...
gr();
plots=
scatter(sol.t,transpose(noise_dataset), legend=false, size=(1000,800),color=:lightblue,grid=false, xlabel="time", lw=lws, label = "Noise", ylabel=["[Xv]" "[Xt]"  "[GLC]" "[GLN]" "[LAC]" "[AMM]" "[mAb]"], layout=(3,3))
plot!(sol.t,transpose(sol_BBF1),color=corbbf1 , lw=lws, label = "True", ylabel=["[Xv]" "[Xt]"  "[GLC]" "[GLN]" "[LAC]" "[AMM]" "[mAb]"], layout=(3,3))
plot!(sol.t,transpose(sol_BBF2),color=corbbf2 , lw=lws, label = "True", ylabel=["[Xv]" "[Xt]"  "[GLC]" "[GLN]" "[LAC]" "[AMM]" "[mAb]"], layout=(3,3))
plot!(sol.t,transpose(sol), color=:red , linestyle=:dot, lw=lws, label = "True", ylabel=["[Xv]" "[Xt]"  "[GLC]" "[GLN]" "[LAC]" "[AMM]" "[mAb]"], layout=(3,3))
...
display(plots)
savefig(FULL_PATH*"/SBM/empirical_tests/results_analysis/Figure_2.png")
...
# savefig(FULL_PATH*"/SBM/empirical_tests/results_analysis/rq3.png")
...
savefig(FULL_PATH*"/SBM/empirical_tests/results_analysis/Figure_4.png")
...
display(plot1l1)
savefig(FULL_PATH*"/SBM/empirical_tests/results_analysis/Figure_5.png")
